...
//
const BotName = 'BOT ./Akbar Kun Bot'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/aku.akbar_/'; // Nama Instagramlu cok
const whatsapplu = '0812-5738-6125'; // Nomor whatsapplu cok
const kapanbotaktif = 'Bot Bisa Mati Kapan Pun'; // Kapan bot lu aktif
